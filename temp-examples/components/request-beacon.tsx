...
export default function RequestBeacon({ position }: RequestBeaconProps) {
    ...
    <group position={position}>
      ...
      <lineSegments ref={ringRef}>
        <bufferGeometry attach="geometry">
          <bufferAttribute attach="attributes-position" count={33} array={orbitPoints} itemSize={3} />
        </bufferGeometry>
        <lineBasicMaterial color={new THREE.Color(1.0, 0.7, 0.2)} opacity={0.8} transparent linewidth={2} />
      </lineSegments>
      ...
      <lineSegments>
        ...
        <lineBasicMaterial color={new THREE.Color(1.0, 0.7, 0.2)} opacity={0.3} transparent linewidth={6} />
      </lineSegments>
    </group>
  )
}
