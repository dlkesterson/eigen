...
export function useOmnibox() {
    ...
    const actions = useMemo(
        ...
        [
            ...
            ui.setShowHelp,
            ui.reset,
            context.setFocusedDevice,
            context.setFocusedFolder,
            context.setFocusedFile,
            context.pushBreadcrumb,
            context.popBreadcrumb,
            context.clearContext,
            context.addRecentCommand,
            history.addEntry,
            history.clearHistory,
            history.addFavorite,
            history.removeFavorite,
            visualization.setVisualization,
            visualization.setSelectedObjects,
            visualization.addSelectedObject,
            visualization.removeSelectedObject,
